    ...
    return (
      <View style={styles.container}>
        <View style={styles.top}>
          <Svg width="100%" height="70%" viewBox="0 0 1201 821">
        ...
        <KeyboardAvoidingView behavior='padding' style={styles.middle}>
          <TextInput
          onFocus={(e, name='username') => this.focus(e, name='username')}
