...
export default class Splash extends React.Component {
  constructor () {
    ...
    this.state = {
      ...
      chitAnim: new Animated.Value(0),
      chatAnim: new Animated.Value(0)
    }
  }
  ...
  render () {
    ...
    const tr1 = this.state.chitAnim.interpolate({inputRange: [0, 1], outputRange: [-600, 350]})
    const tr2 = this.state.chatAnim.interpolate({inputRange: [0, 1], outputRange: [2000, 750]})
    return (
  ...
  <G id='Chitchatlogo' transform='translate(-150 -110)'>
    ...
    <AnimatedCircle
      ...
      fill='#add1d2'
    />
    <AnimatedG style={{transform: [{translateX: tr1}, {translateY: 398}]}} id='chit' transform='translate(-800 398)' opacity='0.997'>
      <Path
        id='Tracé_9'
        data-name='Tracé 9'
    ...
    <AnimatedG style={{transform: [{translateX: tr2}, {translateY: 398}]}} id='chat' transform='translate(2000 405.735)'>
      <Path
        id='Tracé_13'
        data-name='Tracé 13'
